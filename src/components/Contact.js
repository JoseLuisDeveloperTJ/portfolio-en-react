      ...
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d107683.22848301684!2d-117.03020772521279!3d32.49673250070876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80d9390226587bd3%3A0x14724bafa4e62456!2sTijuana%2C%20B.C.!5e0!3m2!1ses-419!2smx!4v1684974654870!5m2!1ses-419!2smx"
          />
          <div className="bg-gray-900 relative flex flex-wrap py-6 px-10 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a className="text-indigo-400 leading-relaxed">
                joseluisarteagamx@gmail.com
              </a>
              <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">
                NÚMERO DE TELÉFONO
              </h2>
              <p className="leading-relaxed">52 (664) 296 2258</p>
            </div>
          </div>
        </div>
        <form
